...
.border-subscriptionSolid {
  --tw-border-opacity: 1;
  border-color: rgb(243 66 19 / var(--tw-border-opacity, 1));
}
...
.bg-selectedListItem {
  --tw-bg-opacity: 1;
  background-color: rgb(6 51 82 / var(--tw-bg-opacity, 1));
}
.bg-subscriptionBg {
  --tw-bg-opacity: 1;
  background-color: rgb(254 240 236 / var(--tw-bg-opacity, 1));
}
.bg-subscriptionBgDark {
  --tw-bg-opacity: 1;
  background-color: rgb(252 209 197 / var(--tw-bg-opacity, 1));
}
.bg-subscriptionSolid {
  --tw-bg-opacity: 1;
  background-color: rgb(243 66 19 / var(--tw-bg-opacity, 1));
}
.bg-white {
  --tw-bg-opacity: 1;
...
.text-subscriptionText {
  --tw-text-opacity: 1;
  color: rgb(233 60 12 / var(--tw-text-opacity, 1));
}
.text-white {
  --tw-text-opacity: 1;
